...
namespace SmartTrader.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251016115221_AddHigherTimeframeCandles")]
    partial class AddHigherTimeframeCandles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTrader.Infrastructure.Persistence.Entities.Candle15m", b =>
                {
                    ...
                    b.HasIndex("SymbolId", "TsOpen")
                        .HasDatabaseName("ix_candles_15m_symbol_tsopen_desc");

                    b.ToTable("candles_15m", "market");
                });
            ...
            modelBuilder.Entity("SmartTrader.Infrastructure.Persistence.Entities.Candle5m", b =>
                {
                    b.Property<Guid>("SymbolId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SymbolId", "TsOpen")
                        .HasDatabaseName("ix_candles_5m_symbol_tsopen_desc");

                    b.ToTable("candles_5m", "market");
                });
